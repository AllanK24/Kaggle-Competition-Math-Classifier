...
def create_qwen25_classifier_with_lora(
    model_id:str,
    ...
    model = Qwen25Classifier(config=config, base_model=base_model, lora_config=lora_config, num_classes=num_classes, add_dropout=add_dropout, dropout_prob=dropout_prob).to(device)
